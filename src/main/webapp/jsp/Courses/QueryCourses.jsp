					...
					<tbody>
						<c:forEach items="${msg}" var="obj">
							<tr>
								...
								<td><c:if test="${obj.cimage != null}"><img alt="" src="${obj.cimage}"></c:if>
								<c:if test="${obj.cimage == null}"><img alt="" src="https://i0.hdslb.com/bfs/archive/2de1aab69a47d6056056bf70cc1dcef51e6d4c01.jpg"></c:if>
								</td>
								<td>${obj.cinfo}</td>
						...
						<tr>
							<th colspan="6">
								...
								${pageInfo.total } 条记录 <!-- 分页条信息 -->
									<a href="/Net/jsp/Courses/SearchByAnything.do?pn=1">首页</a>
									<c:if test="${pageInfo.hasPreviousPage }">
										<a href="/Net/jsp/Courses/SearchByAnything.do?pn=${pageInfo.pageNum-1}">
												<span>&laquo;</span>
										</a>
									</c:if>
									<c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
										...
										<c:if test="${page_Num != pageInfo.pageNum }">
											<a href="/Net/jsp/Courses/SearchByAnything.do?pn=${page_Num }">${page_Num }</a>
										</c:if>
									</c:forEach>
									...
									<a href="/Net/jsp/Courses/SearchByAnything.do?pn=${pageInfo.pages}">末页</a>							
							</th>
						</tr>
					</tbody>
				</table>
