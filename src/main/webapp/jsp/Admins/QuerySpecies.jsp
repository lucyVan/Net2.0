						...
						<tbody>
							...
							<tr>
								<th colspan="5">
									...
									href="/Net/jsp/Admins/QuerySpecies.do?pn=1">首页</a> <c:if
										test="${pageInfo.hasPreviousPage }">
										<a
											href="/Net/jsp/Admins/QuerySpecies.do?pn=${pageInfo.pageNum-1}">
											<span>&laquo;</span>
										</a>
										...
										<c:if test="${page_Num != pageInfo.pageNum }">
											<a href="/Net/jsp/Admins/QuerySpecies.do?pn=${page_Num }">${page_Num }</a>
										</c:if>
									...
									</c:if> <a href="/Net/jsp/Admins/QuerySpecies.do?pn=${pageInfo.pages}">末页</a>
								</th>
							</tr>
						</tbody>
					</table>
