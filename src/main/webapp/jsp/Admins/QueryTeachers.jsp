						...
						<tbody>
							<c:forEach items="${msg}" var="obj">
								<tr>
									...
									<td><a style="width: 100%" type="button"
										href="/Net/jsp/Admins/DeleteTeachers.do/${obj.tid}"
										class="layui-btn layui-btn-radius  layui-btn-normal">删除</a></td>
									<td><a style="width: 100%" type="button"
										href="/Net/jsp/Admins/UpdateTeachers.do/${obj.tid}"
										class="layui-btn layui-btn-radius  layui-btn-normal">修改</a></td>
								</tr>
							</c:forEach>
							<tr>
								<th colspan="8"><a style="width: 100%" type="button"
									href="/Net/jsp/Admins/InsertTeachers.do"
							...
							<tr>
								<th colspan="8">
									...
									href="/Net/jsp/Admins/QueryTeachers.do?pn=1">首页</a> <c:if
										test="${pageInfo.hasPreviousPage }">
										<a
											href="/Net/jsp/Admins/QueryTeachers.do?pn=${pageInfo.pageNum-1}">
											<span>&laquo;</span>
										</a>
										...
										<c:if test="${page_Num != pageInfo.pageNum }">
											<a href="/Net/jsp/Admins/QueryTeachers.do?pn=${page_Num }">${page_Num }</a>
										</c:if>
									...
									href="/Net/jsp/Admins/QueryTeachers.do?pn=${pageInfo.pages}">末页</a>
								</th>
							</tr>
						</tbody>
					</table>
